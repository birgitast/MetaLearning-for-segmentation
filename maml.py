...
from utils import tensors_to_device, compute_accuracy, get_dice_score, jaccard_idx, DiceLoss
...
class ModelAgnosticMetaLearning(object):
    ...
    def get_outer_loss(self, batch, is_test=False):
        """Iterate over tasks in batch, return mean meta loss """
        ...
        for task_id, (train_inputs, train_targets, labels, test_inputs, test_targets, _) \
            ...
            # Adapt model params on support set
            ...
            # Evaluate model params on query set
    ...
    def adapt(self, inputs, targets, is_classification_task=None,
        ...
        # Activate train mode also during evaluation for task-specific adaption
    ...
    def train(self, dataloader, max_batches=500, verbose=True, **kwargs):
        """One training epoch on meta training set"""
        sum_mean_losses = 0
    ...
    def train_iter(self, dataloader, max_batches=500):
        """Iterate over batches, update meta knowledge after each batch"""
        ...
        while num_batches < max_batches:
            for batch in dataloader:
                ...
                # Outer loop optimization of meta knowledge 
                outer_loss.backward()              
                self.optimizer.step()          
                num_batches += 1
    ...
    def evaluate_iter(self, dataloader, max_batches=500, is_test=False):
        """One evaluation iteration, no outer loop optimization"""
